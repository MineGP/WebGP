...
public static class MvcExtensions
{
    ...
    /// <param name="controllerTypes">The controller types that are allowed. </param>
    public static IMvcCoreBuilder UseSpecificControllers(this IMvcCoreBuilder mvcCoreBuilder, params Type[] controllerTypes)
        => mvcCoreBuilder.ConfigureApplicationPartManager(partManager => partManager.UseSpecificControllers(controllerTypes));
    ...
    private class InternalControllerFeatureProvider : ControllerFeatureProvider
    {
        ...
        protected override bool IsController(TypeInfo typeInfo)
        {
            ...
            if (!typeInfo.Name.EndsWith(ControllerTypeNameSuffix, StringComparison.OrdinalIgnoreCase) &&
                       !typeInfo.IsDefined(typeof(Microsoft.AspNetCore.Mvc.ControllerAttribute))) return false;
            return true;
        }
    }
}
