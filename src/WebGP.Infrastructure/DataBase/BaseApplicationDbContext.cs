...
{
    public abstract class BaseApplicationDbContext<T> : DbContext, IContext where T : BaseApplicationDbContext<T>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            OnModelCreatingAbstract(modelBuilder);
        }

        protected abstract void OnModelCreatingAbstract(ModelBuilder modelBuilder);
    }
}
