...
public class OnlineLogController : ControllerBase
{
    ...
    {
        return _mediator.Send(new GetOnlineLogByStaticIDQuery(staticID, from, to));
    }
    ...
    public Task<IDictionary<string, OnlineLogVM>> GetByUUID(
        ...
        [FromQuery(Name = "to")] DateOnly to)
    {
        return _mediator.Send(new GetOnlineLogByUUIDQuery(uuid, from, to));
    }
    ...
    public Task<IEnumerable<OnlineLogVM>> GetByUserName(
        ...
        [FromQuery(Name = "to")] DateOnly to)
    {
        return _mediator.Send(new GetOnlineLogByUserNameQuery(userName, from, to));
    }
}