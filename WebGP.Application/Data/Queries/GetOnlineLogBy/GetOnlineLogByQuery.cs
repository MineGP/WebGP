...
namespace WebGP.Application.Data.Queries.GetOnlineLogBy
{
        ...
        IRequestHandler<GetOnlineLogByUUIDQuery, IDictionary<string, OnlineLogVM>>
    {
        ...
        public async Task<IDictionary<int, OnlineLogVM>> Handle(GetOnlineLogByStaticIDQuery request, CancellationToken cancellationToken)
            => await GetBy(request)
        ...
        public async Task<IDictionary<string, OnlineLogVM>> Handle(GetOnlineLogByUUIDQuery request, CancellationToken cancellationToken)
            => await GetBy(request)
